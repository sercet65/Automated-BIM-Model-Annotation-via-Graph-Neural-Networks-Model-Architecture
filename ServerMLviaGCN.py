...
import pandas as pd
import os
from visualize_graph import plot_training_validation, plot_test_accuracy, plot_confusion_matrix, plot_prediction_distribution, plot_validation_accuracy
import numpy as np
...
if __name__ == "__main__":
    ...
    for epoch in range(1, 300):
        ...
        output_folder = r'C:\Users\ge26rix\Desktop\Python\4.OutputML_GCN'
    ...
    # Make predictions using the trained model
        ...
        plot_prediction_distribution(predictions, label_types, prediction_distribution_output_path, title='Prediction Distribution of Label Types for GCN Model')
        # Plot and save test accuracy
        test_accuracy_plot_path = os.path.join(output_folder, 'test_accuracy_plot.png')
        plot_test_accuracy(test_accuracy_value , final_epoch, test_accuracy_plot_path, title="Test Accuracy for GCN Model")
        ...
        plot_confusion_matrix(y_true, y_pred, ['No Label', 'Wall with Dimension', 'Door Label', 'Zone Stamp'], confusion_matrix_plot_path, title="Confusion Matrix for GCN Model")